...
/**
 * Vue admin des missions (#dashboard-admin, module 4), portée iso depuis
 * `server/utils/adminMissionStore.ts` (ADR-0017) : une « mission » est une
 * commande en séquestre (`EscrowOrder`), dont le cycle de vie couvre déjà
 * avance payée → en cours → terminée → validée / annulée / en litige. Les
 * brouillons (fiches préalables) viennent du store volatile des demandes.
 */
