 ...
 * Porté **verbatim** depuis `server/utils/sms.ts` (ADR-0016).
 *
 * Deux drivers disponibles, choisis via les variables d'environnement :
 *
 * 1. Brevo (prioritaire) — même API et même clé que l'email (`./email`), donc
 *    un seul fournisseur pour email + SMS. Configuration :
