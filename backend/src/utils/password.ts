 ...
 * supplémentaire). Porté **verbatim** depuis `server/utils/password.ts`
 * (ADR-0016) : même primitive, même format `salt:key`, mêmes règles de
 * robustesse (#125) — un hash produit par Nitro reste vérifiable ici et
 * réciproquement, condition du « zéro changement fonctionnel ».
 */
