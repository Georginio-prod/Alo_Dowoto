 ...
 * profils prestataires, avis, demandes de service et soumissions KYC sont
 * également persistés dans PostgreSQL. Ce script reste volontairement limité à
 * un jeu de démonstration d'administration, reproductible et idempotent.
 *
 * Lancement : `npm run db:seed` depuis la racine.
 */
