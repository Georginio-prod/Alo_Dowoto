 ...
 * Contrairement à `providerDirectory.ts` (format de téléphone connu à
 * l'avance), ce champ est du texte libre : la fonction détecte e-mail /
 * numéro / texte quelconque plutôt que de supposer un format fixe.
 */
