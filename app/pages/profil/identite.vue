...
/** Édition de l'identité (nom d'utilisateur, prénom, nom, localisation), extraite du hub `/profil` (#165, même page qu'auparavant, désormais sous sa propre route dédiée). */
