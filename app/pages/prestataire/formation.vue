...
/**
 * Parcours de formation du prestataire (#hub-profil-prestataire) : liste de
 * formations (intitulé, établissement, année), sur le même schéma que les
 * autres pages profil dédiées.
 */
