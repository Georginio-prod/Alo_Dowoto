/**
 * Contenu FAQ (extrait de app/pages/faq.vue) : donnée de configuration
 * partagée entre la page FAQ et l'outil `consulterFAQ` de l'assistant IA
 * (server/utils/ai/tools.ts) — l'assistant doit répondre à partir de ce
 * contenu réel, jamais en l'inventant (règle anti-hallucination, #geoloc/2.1).
 */
